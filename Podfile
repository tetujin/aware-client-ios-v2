...
target 'aware-client-ios-v2' do
  ...
  pod 'AWAREFramework', '~> 1.9'
  pod 'AWAREFramework/Microphone' , '~> 1.9'
  pod 'AWAREFramework/MotionActivity', '~> 1.9'
  pod 'AWAREFramework/Bluetooth', '~> 1.9'
  pod 'AWAREFramework/Calendar', '~> 1.9'
  pod 'AWAREFramework/Contact', '~> 1.9'
  pod 'AWAREFramework/HealthKit', '~> 1.9'
